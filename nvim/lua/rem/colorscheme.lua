...
-- приглушённый красный для удалённого (было #43292d — слишком яркое)
local del_bg = "#33262a"
...
vim.api.nvim_set_hl(0, "DiffDelete", { bg = del_bg, fg = "#7d4c52" }) -- удалённые строки / заполнитель
...
local function set_diff_hl()
  ...
  vim.api.nvim_set_hl(0, "DiffDelete", { bg = del_bg, fg = "#b3838a" })
  ...
  vim.api.nvim_set_hl(0, "DiffviewDiffAddAsDelete", { bg = del_bg, fg = "#b3838a" })
  ...
  vim.api.nvim_set_hl(0, "DiffviewDiffDeleteDim", { bg = del_bg, fg = "#585f6e" })
